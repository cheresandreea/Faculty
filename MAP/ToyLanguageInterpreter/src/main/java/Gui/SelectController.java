...
public class SelectController{
    ...
    public void initialize() {
        ...
        }catch (MyException | EvaluationException e)
        {
        ...
        RunExample example1 = new RunExample("1", "(int v; (v=2; print(v)))", controller1);
        RunExample example2 = new RunExample("2", "(int a; (int b; (a=2+3*5; (b=a+1; print(b)))))", controller2);
        RunExample example3 = new RunExample("3", "(bool a; (int v; (a=true; (if(a) then(v=2) else(v=3); print(v)))))", controller3);
        RunExample example4 = new RunExample("4", "(string varf; (varf=test.in; (openRFile(varf);; (int varc; (readFile(varf, varc);; (print(varc); (readFile(varf, varc);; (print(varc); closeRFile(varf);))))))))", controller4);
        RunExample example5 = new RunExample("5", "(int a; (int b; (a=2; (if(a < 3) then(b=10) else(b=5); print(b)))))", controller5);
        RunExample example6 = new RunExample("6", "(Ref(int) v; (new(v, 20);; (Ref(Ref(int)) a; (new(a, v);; (new(v, 30);; (print(v); (print(readHeap(v)); (print(a); (print(readHeap(a)); print(readHeap(readHeap(a))))))))))))", controller6);
        RunExample example7 = new RunExample("7", "(int v; (v=4; (while(v > 0){(print(v); v=v-1)}; print(v))))", controller7);
        RunExample example8 = new RunExample("8", "(int v; (Ref(int) a; (v=10; (new(a, 22);; (fork( (writeHeap(a, 30);; (v=32; (print(v); print(readHeap(a))))) );; (print(v); print(readHeap(a))))))))", controller8);


        this.examplesListView.getItems().add(example1);
        this.examplesListView.getItems().add(example2);
        this.examplesListView.getItems().add(example3);
        this.examplesListView.getItems().add(example4);
        this.examplesListView.getItems().add(example5);
        this.examplesListView.getItems().add(example6);
        this.examplesListView.getItems().add(example7);
        this.examplesListView.getItems().add(example8);
