...
public class MainApp extends Application {
    ...
    public void start(Stage stage) throws IOException {
        FXMLLoader fxmlLoader1 = new FXMLLoader(MainApp.class.getResource("select.fxml"));
        Scene scene1 = new Scene(fxmlLoader1.load(), 1050, 650);
        SelectController selectController = fxmlLoader1.getController();

        FXMLLoader fxmlLoader2 = new FXMLLoader(MainApp.class.getResource("main.fxml"));
