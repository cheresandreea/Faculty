...
function ViewReviews() {
    ...
    useEffect(() => {
        const checkServerStatus = async () => {
            ...
            try {
                await axios.get('https://mpp-backend-425314.lm.r.appspot.com/collars/reviews');
            } catch (error) {
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmed) {
            try {
                await axios.delete(`https://mpp-backend-425314.lm.r.appspot.com/collars/reviews/delete/${id}`);
