...
export const fetchCollars = () => async (dispatch) => {
    ...
    try {
        const res = await axios.get("https://mpp-backend-425314.lm.r.appspot.com/collars");
...
export const fetchReviews = () => async (dispatch) => {
    ...
    try {
        const res = await axios.get("https://mpp-backend-425314.lm.r.appspot.com/collars/reviews");
